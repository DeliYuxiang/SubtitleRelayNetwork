    ...
    <div id="app" v-scope @mounted="init()">
        ...
        <footer>
            <p style="text-align: center; padding: 4rem; color: #334155; font-size: 0.85rem;">
                &copy; 2026 Subtitle Relay Network. Distributed by Cloudflare Workers.<br>
                <a href="https://github.com/DeliYuxiang/SubtitleRelayNetwork" target="_blank" rel="noopener" style="color: #475569; text-decoration: none; margin-top: 0.5rem; display: inline-block;">
                    ★ Star on GitHub
                </a>
            </p>
        </footer>
